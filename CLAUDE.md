...
- **Reste à vivre prévisionnel** (accueil) : `revenus du mois − total factures − budgets alloués − épargne mensuelle prévue` (`getPlannedMonthlySavings`, objectifs non atteints). C'est du prévisionnel basé sur les montants planifiés, pas sur les dépenses réelles.
