...
- **Budgets — reste à allouer** : carte en tête de l'écran Budgets et calcul en direct dans `nouveau-budget.tsx` : `revenus du mois (y compris à venir) − factures − épargne prévue − budgets alloués` (en excluant le budget en cours d'édition).
